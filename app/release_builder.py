...
def _contains_platform_path(package_dir: Path) -> bool:
    patterns = ("E:\\", "business-flow-engine\\data\\scenarios", "app.mcp_server")
...
def _write_runtime(package_dir: Path) -> None:
    ...
    mcp_text = (_APP_DIR / "mcp_server.py").read_text(encoding="utf-8")
    ...
    runtime_text = (_APP_DIR / "scenario_runtime.py").read_text(encoding="utf-8")
