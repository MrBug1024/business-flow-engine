...
from .models import Scenario, TableMeta, TableRole
from .table_io import _sanitize_rows
...
def _sample_result_rows(file_path: str, sample_size: int = _SAMPLE_SIZE) -> list[dict[str, Any]]:
    ...
    from . import table_io  # noqa: PLC0415
    ...
    from .table_io import _jsonable  # noqa: PLC0415
