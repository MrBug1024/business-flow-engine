...
from app.distillation import inference, metadata, strategies, transform_builder
from app.distillation import trace_sampling as _ts
from app.domain import scenario_state
from app.domain import validators as _val
from app.domain.models import Scenario, ScenarioStatus, TableRole
...
def build_tools(scenario_id: str) -> list[StructuredTool]:
    ...
    def correct_relation(
        ...
        if scenario.relations is None:
            from app.domain.models import RelationResult
