...
Object.assign(studioCopy.zh, {
  ...
  retryContinue: '继续执行',
  distillationContinuationFailed: '审核结论已保存，但后续业务处理未完成。确认服务可用后可手动继续。',
  retryDistillationContinuation: '继续后续处理',
...
Object.assign(studioCopy.en, {
  ...
  distillationContinuationFailed: 'The review is saved, but the follow-up business work did not finish. Continue manually when the service is available.',
  retryDistillationContinuation: 'Continue follow-up',
